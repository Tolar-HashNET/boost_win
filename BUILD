...
BOOST_CTX_ASM_SOURCES = select({
    ":linux_arm": [
        ...
        "src/libs/context/src/asm/make_arm_aapcs_elf_gas.S",
        "src/libs/context/src/asm/ontop_arm_aapcs_elf_gas.S",
    ],
    ":linux_x86_64": [
        "src/libs/context/src/asm/jump_x86_64_sysv_elf_gas.S",
        "src/libs/context/src/asm/make_x86_64_sysv_elf_gas.S",
        "src/libs/context/src/asm/ontop_x86_64_sysv_elf_gas.S",
    ],
    ":osx_x86_64": [
        "src/libs/context/src/asm/jump_x86_64_sysv_macho_gas.S",
        "src/libs/context/src/asm/make_x86_64_sysv_macho_gas.S",
...
boost_library(
    ...
    srcs = BOOST_CTX_ASM_SOURCES + select({
        ":linux": [
            "src/libs/context/src/posix/stack_traits.cpp",
        ],
        ":osx_x86_64": [
            "src/libs/context/src/posix/stack_traits.cpp",
        ],
    ...
    exclude_src = [
        ...
        "src/libs/context/src/untested.cpp",
...
BOOST_FIBER_NUMA_SRCS = select({
    ...
    ":linux_x86_64": [
        "src/libs/fiber/src/numa/linux/pin_thread.cpp",
        "src/libs/fiber/src/numa/linux/topology.cpp",
    ],
    ":windows_x86_64": [
        "src/libs/fiber/src/numa/windows/pin_thread.cpp",
        "src/libs/fiber/src/numa/windows/topology.cpp",
    ],
    "//conditions:default": [],
})
...
boost_library(
    name = "fiber",
    srcs = BOOST_FIBER_NUMA_SRCS + glob(["src/libs/fiber/src/algo/**/*.cpp"]) + [
        "src/libs/fiber/examples/asio/detail/yield.hpp",
    ],
    hdrs = [
        "src/libs/fiber/examples/asio/round_robin.hpp",
        "src/libs/fiber/examples/asio/yield.hpp",
    ],
    copts = select({
        ":windows_x86_64": [
    ...
    exclude_src = ["src/libs/fiber/src/numa/**/*.cpp"],
    linkopts = select({
        ":linux": [
            "-lpthread",
        ],
...
boost_library(
    name = "container",
    srcs = [
        "src/libs/container/src/dlmalloc_ext_2_8_6.c",
    ],
    hdrs = [
...
boost_library(
    ...
    hdrs = [
        ...
        "src/boost/polymorphic_cast.hpp",
        "src/boost/polymorphic_pointer_cast.hpp",
    ],
    deps = [
        ":assert",
        ":config",
...
BOOST_CORO_SRCS = select({
    ":linux": [
        "src/libs/coroutine/src/posix/stack_traits.cpp",
    ],
    ":osx_x86_64": [
        "src/libs/coroutine/src/posix/stack_traits.cpp",
    ],
    ":windows_x86_64": [
        "src/libs/coroutine/src/windows/stack_traits.cpp",
    ],
})
...
boost_library(
    ...
    srcs = BOOST_CORO_SRCS + [
        "src/libs/coroutine/src/detail/coroutine_context.cpp",
    ],
    deps = [
        ":config",
        ":context",
...
boost_library(
    name = "date_time",
    srcs = glob(["src/libs/date_time/src/**/*.cpp"]),
    hdrs = glob(["src/libs/date_time/src/**/*.hpp"]),
    deps = [
        ":algorithm",
        ":io",
        ":lexical_cast",
...
boost_library(
    ...
    hdrs = [
        "src/boost/blank.hpp",
        "src/boost/blank_fwd.hpp",
        "src/boost/cstdlib.hpp",
    ],
    deps = [
        ":limits",
    ],
...
boost_library(
    name = "iterator",
    hdrs = [
        "src/boost/function_output_iterator.hpp",
        "src/boost/generator_iterator.hpp",
        "src/boost/indirect_reference.hpp",
        "src/boost/iterator_adaptors.hpp",
        "src/boost/next_prior.hpp",
        "src/boost/pointee.hpp",
        "src/boost/shared_container_iterator.hpp",
    ],
    deps = [
        ":detail",
        ":static_assert",
...
boost_library(
    ...
    srcs = select({
        ":linux": glob(
            [
                "src/libs/locale/src/**/*.cpp",
                "src/libs/locale/src/**/*.hpp",
                "src/libs/locale/src/**/*.ipp",
            ],
            exclude = [
                "src/libs/locale/src/win32/*.cpp",
                "src/libs/locale/src/icu/*.cpp",
            ],
        ),
        ":osx_x86_64":  glob(
            [
...
boost_library(
    name = "multi_index",
    hdrs = [
        "src/boost/multi_index_container.hpp",
        "src/boost/multi_index_container_fwd.hpp",
    ],
    deps = [
        ":foreach",
        ":serialization",
...
boost_library(
    ...
    hdrs = glob([
        "src/boost/numeric/conversion/**/*.hpp",
    ]),
    deps = [
        ":config",
        ":detail",
...
boost_library(
    ...
    hdrs = [
        ...
        "src/boost/make_unique.hpp",
        "src/boost/pointer_to_other.hpp",
...
BOOST_STACKTRACE_SOURCES = select({
    ":linux_arm": [
        "src/libs/stacktrace/src/basic.cpp",
        "src/libs/stacktrace/src/noop.cpp",
    ],
    ":linux_x86_64": [
        "src/libs/stacktrace/src/backtrace.cpp",
    ],
    ":osx_x86_64": [
        "src/libs/stacktrace/src/addr2line.cpp",
    ],
    ":windows_x86_64": [
        "src/libs/stacktrace/src/windbg.cpp",
        "src/libs/stacktrace/src/windbg_cached.cpp",
    ],
})
...
boost_library(
    ...
    exclude_src = ["src/libs/stacktrace/src/*.cpp"],
    linkopts = select({
        ":linux_x86_64": [
            "-lbacktrace -ldl",
        ],
...
boost_library(
    name = "tribool",
    hdrs = [
        "src/boost/logic/tribool.hpp",
        "src/boost/logic/tribool_fwd.hpp",
    ],
    deps = [
        ":config",
        ":detail",
...
boost_library(
    name = "unordered",
    hdrs = [
        "src/boost/unordered_map.hpp",
        "src/boost/unordered_set.hpp",
    ],
    deps = [
        ":assert",
        ":config",
...
cc_library(
    name = "log_dump_ssse3",
    srcs = ["src/libs/log/src/dump_ssse3.cpp"] + hdr_list("log"),
    hdrs = [],
    copts = ["-msse4.2"],
...
boost_library(
    ...
    exclude_src = [
        ...
        "src/libs/log/src/dump_ssse3.cpp",
    ],
...
boost_library(
    ...
    hdrs = [
        ...
        "src/boost/pending/relaxed_heap.hpp",
    ],
    deps = [
        ":algorithm",
        ":conversion",
